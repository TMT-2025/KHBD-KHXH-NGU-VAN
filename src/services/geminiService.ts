    ...
    3. Trong "III. TIẾN TRÌNH DẠY HỌC":
       ...
       - Đảm bảo thiết kế các hoạt động chi tiết cực kỳ chuẩn chỉ bám sát CV5512, thể hiện đầy đủ các mục cho TẤT CẢ các hoạt động trong mọi tiết học:
         ...
         c) Sản phẩm: Kết quả bài làm của học sinh (đáp án chi tiết, bảng biểu đã điền, ý kiến trả lời cụ thể, bài trình bày...), đảm bảo độ phân giải vật lý cao nhất của sản phẩm mẫu, tuyệt đối không viết chung chung đại khái.
              ...
              * QUY TẮC BẮT BUỘC 4: Trong cột "Sản phẩm dự kiến", bạn PHẢI trình bày kết quả học tập THỰC TẾ, CỰC KỲ CHI TIẾT và TĂNG DUNG LƯỢNG NỘI DUNG/SỐ LƯỢNG CHỮ đến mức tối đa để làm tài liệu chuẩn mực cho giáo viên (tham khảo phong cách chi tiết của tài liệu TD.pdf). Tuyệt đối không viết mô tả chung chung về sản phẩm. Ví dụ: Thay vì viết "Sản phẩm trên Padlet: Viết đoạn văn ngắn 5-7 câu sử dụng ít nhất 3 từ Hán Việt.", bạn phải VIẾT RA ĐOẠN VĂN MẪU THỰC TẾ dài 5-7 câu có sử dụng ít nhất 3 từ Hán Việt đó. Nếu có bảng so sánh, hãy lập bảng so sánh đầy đủ nội dung chi tiết trong cột Sản phẩm dự kiến.
