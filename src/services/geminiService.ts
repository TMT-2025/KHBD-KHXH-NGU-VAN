       ...
       - Đảm bảo thiết kế các hoạt động chi tiết cực kỳ chuẩn chỉ bám sát CV5512, thể hiện đầy đủ các mục cho TẤT CẢ các hoạt động trong mọi tiết học:
         ...
         c) Sản phẩm: Kết quả bài làm của học sinh (đáp án chi tiết, bảng biểu đã điền, ý kiến trả lời cụ thể, bài trình bày...), đảm bảo độ phân giải vật lý cao nhất của sản phẩm mẫu, tuyệt đối không viết chung chung đại khái.
              ...
              * QUY TẮC BẮT BUỘC 3: Bảng có đúng 2 cột mang tên: "Hoạt động của GV và HS" và "Sản phẩm dự kiến". Cột thứ nhất "Hoạt động của GV và HS" phải có đầy đủ 4 bước như mẫu dưới đây (sử dụng thẻ <br> để ngăn cách các dòng/ý hành động của giáo viên và học sinh trong ô):
                - **Bước 1: Gv giao nhiệm vụ cho học sinh** <br> (GV giao nhiệm vụ cụ thể, câu hỏi/nhiệm vụ học tập, thời gian, học liệu số và hình thức làm việc. Ghi rõ cách GV sử dụng bảng tương tác hoặc các công cụ trực tuyến như Kahoot!, Quizizz, Blooket, Padlet, Mentimeter... để giao nhiệm vụ hoặc khởi động).
                - **Bước 2: Học sinh thực hiện nhiệm vụ** <br> (HS thực hiện nhiệm vụ cá nhân/cặp/nhóm; GV theo dõi, hỗ trợ. Tích hợp NLS và AI: Mô tả HS dùng công cụ số/AI để tra cứu dữ liệu, tương tác prompt, kiểm chứng thông tin với mã năng lực số NC1 và mã AI chi tiết (10.A1b, 11.C2a, 12.D2b...) viết dưới dạng văn bản thường không chứa dấu nháy ngược).
                - **Bước 3: Học sinh báo cáo thực hiện kết quả** <br> HS trả lời câu hỏi. <br> Gv quan sát, hỗ trợ, tư vấn <br> (HS báo cáo kết quả thông qua sản phẩm số, phản hồi/trình bày trực tiếp trên bảng tương tác hoặc qua ứng dụng như Padlet, Mentimeter...; HS nhóm khác phản biện, thảo luận; GV điều hành).
              ...
              * QUY TẮC BẮT BUỘC 4: Trong cột "Sản phẩm dự kiến", bạn PHẢI trình bày kết quả học tập THỰC TẾ và CỰC KỲ CHI TIẾT cho những nội dung được yêu cầu ở cột "Hoạt động của GV và HS". Tuyệt đối không chỉ mô tả chung chung về sản phẩm (ví dụ: Thay vì viết "Sản phẩm trên Padlet: Viết đoạn văn ngắn 5-7 câu sử dụng ít nhất 3 từ Hán Việt.", bạn phải VIẾT RA KẾT QUẢ THỰC TẾ của đoạn văn ngắn từ 5-7 câu sử dụng ít nhất 3 từ Hán Việt đó). Cung cấp lời giải đầy đủ, văn bản phân tích, bảng biểu, kiến thức chốt để giáo viên sử dụng làm đáp án chuẩn.
              
              | Hoạt động của GV và HS | Sản phẩm dự kiến |
              | :--- | :--- |
              | **Bước 1: Gv giao nhiệm vụ cho học sinh** <br> GV giao nhiệm vụ học tập rõ ràng, nêu yêu cầu, thời gian, học liệu số và hình thức làm việc. Nêu cách GV sử dụng bảng tương tác hoặc các công cụ trực tuyến (Kahoot!, Quizizz, Blooket, Padlet, Mentimeter...) để khởi động hoặc giao nhiệm vụ học tập. <br><br> **Bước 2: Học sinh thực hiện nhiệm vụ** <br> HS thực hiện nhiệm vụ (cá nhân/cặp/nhóm); GV theo dõi, hỗ trợ. [BẮT BUỘC Tích hợp NLS và AI: Mô tả HS dùng công cụ số/AI để tra cứu dữ liệu, tương tác prompt, kiểm chứng thông tin với mã năng lực số NC1 và mã AI chi tiết (10.A1b, 11.C2a, 12.D2b...) viết dưới dạng văn bản thường không chứa dấu nháy ngược]. <br><br> **Bước 3: Học sinh báo cáo thực hiện kết quả** <br> HS trả lời câu hỏi. <br> Gv quan sát, hỗ trợ, tư vấn <br> HS báo cáo kết quả thông qua các sản phẩm số, phản hồi/trình bày trực tiếp trên bảng tương tác hoặc qua ứng dụng trực tuyến (như đăng sản phẩm lên Padlet, trả lời trên Mentimeter, thảo luận nhóm qua bảng thông minh); HS nhóm khác phản biện, thảo luận; GV điều hành. <br><br> **Bước 4: Nhận xét, đánh giá kết quả thực hiện nhiệm vụ** <br> GV: nhận xét đánh giá kết quả của các cá nhân, chuẩn hóa kiến thức. GV nhận xét, đánh giá tinh thần làm việc và sản phẩm của học sinh, chuẩn hóa kiến thức cốt lõi và chuyển giao nhiệm vụ tiếp theo. | [Đưa ra đáp án chi tiết, kết quả thực hiện bài tập, nội dung bảng biểu đã hoàn thành, viết trực tiếp đoạn văn mẫu, bài viết phân tích, hoặc câu trả lời đầy đủ, chi tiết cho các yêu cầu ở cột bên trái để chốt kiến thức...] |
...
export async function generateLessonPlan(lessonName: string, periods: number, subject: string, grade: string) {
  ...
  const prompt = `
    ...
    - Sử dụng định dạng bảng Markdown (| Cột 1 | Cột 2 |) cho các nội dung so sánh, phân loại, thảo luận nhóm; để trống các ô học sinh cần điền bằng dấu "...".
